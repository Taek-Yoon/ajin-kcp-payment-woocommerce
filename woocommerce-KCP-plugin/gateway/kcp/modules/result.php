...
<?
    ...
    /* = -------------------------------------------------------------------------- = */
    // 포인트
	$pt_idno          = empty($_POST[ "pt_idno"        ]) ? "" : $_POST[ "pt_idno"        ];      // 결제 및 인증 아이디
...
?>
                    <table width="85%" align="center" border="0" cellpadding="0" cellspacing="1" class="margin_top_20">
                        <tr><td colspan="2"  class="title">Result(<?=$req_tx_name?>)</td></tr>
                        <!-- 결과 코드 -->
                        <tr><td class="sub_title1">Result Code</td><td class="sub_content1"><?=$res_cd?></td></tr>
                        <!-- 결과 메시지 -->
                        <tr><td class="sub_title1">Result Message</td><td class="sub_content1"><?=$res_msg?></td></tr>
<?
    // 처리 페이지(pp_cli_hub.jsp)에서 가맹점 DB처리 작업이 실패한 경우 상세메시지를 출력합니다.
    if( !$res_msg_bsucc == "")
    {
?>
                        <tr><td class="sub_title1">Result Detail Message</td><td><?=$res_msg_bsucc?></td></tr>
<?
    }
?>
                    </table>
...
?>
                <table width="85%" align="center" border="0" cellpadding="0" cellspacing="1" class="margin_top_10">
					<tr><td colspan="2"  class="title">Order Information</td></tr>
                    <!-- 주문번호 -->
                    <tr><td class="sub_title1">Order No.</td><td class="sub_content1"><?=$ordr_idxx?></td></tr>
                    <!-- KCP 거래번호 -->
                    <tr><td class="sub_title1">KCP Transaction No.</td><td class="sub_content1"><?=$tno?></td></tr>
                    <!-- 결제금액 -->
                    <tr><td class="sub_title1">Tender Amount</td><td class="sub_content1"><?=$good_mny?>원</td></tr>
                    <!-- 상품명(good_name) -->
                    <tr><td class="sub_title1">Goods Name</td><td class="sub_content1"><?=$good_name?></td></tr>
                    <!-- 주문자명 -->
                    <tr><td class="sub_title1">Buyer Name</td><td class="sub_content1"><?=$buyr_name?></td></tr>
                    <!-- 주문자 전화번호 -->
...
?>
                <table width="85%" align="center" class="margin_top_10">
					<tr><td style="text-align:center"><a href="http://kcpshop.ajinsys.com/"><img src="./img/btn_home.gif" width="108" height="37" alt="처음으로 이동합니다" /></a></td></tr>
                </table>
                </td>
            </tr>
		</table>
